                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                            ...
                            <span>{{__('fa.Student')}}</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="true">
                            <li>
                                <a href="javascript: void(0);" class="has-arrow">{{__('menu.General')}}</a>
                                <ul class="sub-menu" aria-expanded="true">
                                    <li><a href="layouts-dark-sidebar.html">{{__('menu.General')}}</a></li>
                                </ul>
                            </li>

                            <li>
                                <a href="javascript: void(0);" class="has-arrow">{{__('fa.Education')}}</a>
                                <ul class="sub-menu" aria-expanded="true">
                                    <li><a href="layouts-horizontal.html">{{__('fa.Education')}}</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
